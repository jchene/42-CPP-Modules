...
/*   Updated: 2022/11/11 21:09:36 by jchene           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScavTrap::attack(const std::string &target)
{
	if (this->getEp() > 1)
	{
		...
		std::cout << "ScavTrap " << this->_name << " attacks " << target << " with great power, causing " << this->getAd() << " points of damage!" << std::endl;
	}
	else
...
void ScavTrap::guardGate()
{
	if (this->_guardMode)
		...
		std::cout << "ScavTrap " << this->_name << " has started guarding the gate." << std::endl;
